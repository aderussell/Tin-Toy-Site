...
## iOS & macOS apps
The Tin Toy apps perform zero data collection. There is no usage tracking, analytics, or any other data collection beyond the standard crash collection analystics provided by the relevant operating systems and determinate to the users settings for sharing crash information with developers.
